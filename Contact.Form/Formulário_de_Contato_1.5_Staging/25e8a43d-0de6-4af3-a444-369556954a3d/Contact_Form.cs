...
namespace ContactForm
{
    ...
    public class Mailer
    {
        ...
        public Mailer()
        {
            ...
            //Remetente
            from="ccasalicchio@zueuz.net";
            from_name="Mailer do Site";
            //Destinatário
            to="carlos.casalicchio@zueuz.com";
            to_name="Webmaster do Site";
            //Dados do Servidor
            smtp_usr="ccasalicchio@zueuz.net"; //usuário smtp
            smtp_pwd="Yme?notu"; //senha smtp
            smtp_host="smtpout.secureserver.net"; //servidor smtp
