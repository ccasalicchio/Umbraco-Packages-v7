...
(function (factory) {
    ...
    Chart.defaults.global.colors = [
        '#3F3357', // umbraco 7 purple,
        '#65ADA1', // umbraco 7 turquoise
        '#97BBCD', // blue
        '#DCDCDC', // light grey
        '#F7464A', // red
        '#46BFBD', // green
    ...
    function ChartJsFactory(ChartJs, $timeout) {
        ...
        function createChart(type, scope, elem) {
            ...
            console.log(scope, data, type, options);
            data.datasets[0].borderWidth = 3;
            data.datasets[0].borderColor = 'rgba(101, 173, 161, 0.6)';
            data.datasets[0].backgroundColor = 'transparent';
            data.datasets[0].lineTension = 0.2;
            data.datasets[0].pointBorderColor = 'rgba(63, 51, 87, 0.6)'
            data.datasets[0].pointHoverBackgroundColor = 'transparent'

            options.defaultColor = 'rgba(63, 51, 87, 0.6)'
            options.layout = {
                padding: {
                    left: 20,
                    right: 20,
        ...
        function getColor(color) {
            ...
            return {
                ...
                pointBackgroundColor: 'transparent',//rgba(color, alpha),
